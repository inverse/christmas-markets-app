...
4. In the dropdown at the top, select **Pixel 7/8/9** (or equivalent) to simulate a standard Android device screen.
5. Refresh the page to ensure the mobile layout is correctly rendered.
